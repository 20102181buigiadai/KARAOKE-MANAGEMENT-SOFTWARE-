...
public class FrmTimKiemNhanVien extends JFrame implements ActionListener, KeyListener {
	...
	public FrmTimKiemNhanVien(String maNhanVien) {
...
//		cbChucVu.setBackground(color2);
		...
		btnLamMoi.setIcon(new ImageIcon(FrmTimKiemNhanVien.class.getResource("/img/Button-Refresh-icon2.png")));
...
//		txtTenNV.requestFocus();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(btnCapNhatNhanVien)) {
			FrmQuanLyNhanVien frmQuanLyNhanVien = new FrmQuanLyNhanVien(dsTimDuoc);
