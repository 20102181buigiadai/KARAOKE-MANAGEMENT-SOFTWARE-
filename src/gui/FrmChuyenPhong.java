...
//	}
	...
	public FrmChuyenPhong(String maPhongNhan, String maNhanVienNhan) {
		...
		lbl_TieuDe.setIcon(new ImageIcon(
				FrmChuyenPhong.class.getResource("/img/vecteezy_abstract-purple-fluid-wave-background_.jpg")));
		...
		btn_ChuyenPhong.setIcon(new ImageIcon(FrmChuyenPhong.class.getResource("/img/icons8-transfer-50.png")));
		...
		btn_QuayLai.setIcon(new ImageIcon(FrmChuyenPhong.class.getResource("/img/return.png")));
