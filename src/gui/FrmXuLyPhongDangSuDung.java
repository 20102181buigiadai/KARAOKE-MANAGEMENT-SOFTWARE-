...
public class FrmXuLyPhongDangSuDung extends JFrame implements Runnable, ActionListener, MouseListener {
	...
	private static ImageIcon icon_PhongTrong = new ImageIcon(
			FrmXuLyPhongDangSuDung.class.getResource("/img/room-mini-3.png"));
	private static ImageIcon icon_PhongCho = new ImageIcon(
			FrmXuLyPhongDangSuDung.class.getResource("/img/room-mini-2.png"));
	private static ImageIcon icon_PhongDSD = new ImageIcon(
			FrmXuLyPhongDangSuDung.class.getResource("/img/room-mini-1.png"));
	private static ImageIcon icon_PhongVip = new ImageIcon(
			FrmXuLyPhongDangSuDung.class.getResource("/img/vip-Mini.gif"));
	...
	static ArrayList<ChiTietHoaDon_Phong> dsALL_CTHD_Phong = dao_CTHD_Phong.getALLDanhSach();
	static ArrayList<ChiTietHoaDon_DichVu> dsALL_CTHD_DV = dao_CTHD_DV.getAllDanhSach();
	 ...
	 * Create the frame.
	 */
	public FrmXuLyPhongDangSuDung(String nhanVien, String soDTTruyen) {
		setTitle("Đặt phòng");
		...
		lbl_ThoiGianDat_8_1.setIcon(new ImageIcon(FrmXuLyPhongDangSuDung.class.getResource("/img/vip-Mini.gif")));
		...
		btn_QLDichVu.setIcon(new ImageIcon(FrmXuLyPhongDangSuDung.class.getResource("/img/icons8-manage-32.png")));
		...
		btn_ChuyenPhong.setIcon(new ImageIcon(FrmXuLyPhongDangSuDung.class.getResource("/img/icons8-transfer-50.png")));
		...
		btn_ChonPhong.setIcon(new ImageIcon(FrmXuLyPhongDangSuDung.class.getResource("/img/DanhMuc_Them.png")));
		...
		btn_LocDSTheoKH.setIcon(new ImageIcon(FrmXuLyPhongDangSuDung.class.getResource("/img/Search-icon.png")));
		...
		btn_LamMoi.setIcon(new ImageIcon(FrmXuLyPhongDangSuDung.class.getResource("/img/Button-Refresh-icon.png")));
		...
		tb_dsPhongDaChon.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				btn_ChonPhong.setIcon(new ImageIcon(FrmXyLyDatPhong.class.getResource("/img/icons8-close-60.png")));
				// lấy phòng được chọn
...
//		Thêm số điện thoại các khách có phòng đặt
		...
		for (Phong phong : dsDLHienTai) {
			...
			butt_danhSachPhong[dem].addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					btn_ChonPhong.setBackground(new Color(138, 43, 226));
					btn_ChonPhong
							.setIcon(new ImageIcon(FrmXuLyPhongDangSuDung.class.getResource("/img/DanhMuc_Them.png")));
				}
			});
			dem++;
		}
	...
	public static void docThongTinPhong() {
...
//		ArrayList<ChiTietHoaDon_DichVu> dsDichVu = dao_CTHD_DV.getDSTheoMaHD(maHD);
	...
	public static void setIcon(int viTri) {
		...
		if (dsDLHienTai.get(viTri).getLoaiPhong().getTenLoaiPhong().equals("Vip")) {
			iconVip = new JLabel();
			iconVip.setIcon(new ImageIcon(FrmXuLyPhongDangSuDung.class.getResource("/img/VIP.gif")));
	...
	public static boolean kiemTraSDT(String soDT, KhachHang khTruyen) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(btn_QLDichVu)) {
			if (maPhongDuocChon.length() != 0) {
				FrmThemDichVu fr_themDV = new FrmThemDichVu(maPhongDuocChon, maNhanVienTao);
...
//		Chuyển phòng
		if (obj.equals(btn_ChuyenPhong)) {
			if (maPhongDuocChon.length() != 0) {
				FrmChuyenPhong fr_ChuyenPhong = new FrmChuyenPhong(maPhongDuocChon, maNhanVienTao);
		...
		if (obj.equals(btn_LocDSTheoKH)) {
			...
			KhachHang khTim = dao_KhachHang.getKhachHangTheoSoDT(txt_SoDT.getSelectedItem().toString().trim());
			txt_ThongTin.setText("");
			txt_MaPhong.setText("");
			modelHoaDon.setRowCount(0);
			if (khTim == null) {
...
//			khách hàng có hoá đơn
		...
		if (obj.equals(btn_ThanhToan)) {
			...
			NhanVien nhanVien = dao_NhanVien.getNhanVienTheoMa(maNhanVienTao);
			FrmXuLyThanhToan frmThanhToan = new FrmXuLyThanhToan(dsHDThanhToan, nhanVien);
	...
	public void locDSPhongTheoKhach(KhachHang khTim) {
	...
	public PhieuDatPhong layPhieuDatPhongCuoi() {
