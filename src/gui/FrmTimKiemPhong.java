...
public class FrmTimKiemPhong extends JFrame implements KeyListener, ActionListener {
	...
	public FrmTimKiemPhong(String maNhanVien) {
	...
	private void createUI(String maNhanVienTruyen) {
...
//		Kiểm tra: nếu là người quản lý thì thêm panel Cập nhập phòng
		...
		if (maNhanVienTruyen.equals("admin") || nVien.getLoaiNhanVien().getMaLoai().equals("LNV001"))
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btnCapNhatPhong)) {
			FrmQuanLyPhong frmQuanLyPhong = new FrmQuanLyPhong(dsTimDuoc);
