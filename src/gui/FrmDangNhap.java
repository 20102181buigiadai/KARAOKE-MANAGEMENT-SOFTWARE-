...
//	private JPanel contentPane;
	...
	public FrmDangNhap() {
		...
		Jlab_Background.setIcon(new ImageIcon(getClass().getResource("/img/Login-02 (1).jpg")));
		...
		lbl_Anhpass.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pass.png")));
		lbl_Anhpass.setBounds(598, 274, 70, 43);

		lbl_AnhDN = new JLabel();
		contentPane.add(lbl_AnhDN);
		lbl_AnhDN.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/user.png")));
		...
		txt_TenDangNhap.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				...
				TaiKhoan taiKhoan = dao_TaiKhoan.getTaiKhoanTheoMa(tenDN);
		...
		btnDangNhap.setIcon(new ImageIcon(FrmDangNhap.class.getResource("/img/icons8-login-32.png")));
	...
	public String kiemTraLoaiNhanVien(String tenDangNhap, String matKhau) {
	...
	public boolean quenMatKhau(String tenDN, String sdt) {
