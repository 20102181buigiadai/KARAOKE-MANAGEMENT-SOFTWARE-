...
public class FrmTimKiemKhachHang extends JFrame implements ActionListener, KeyListener {
	...
	private void createUI() {
		 ...
		 * ImageIcon(FrmTimKiemKhachHang.class.getResource("/img/DanhMuc_Them.png")));
		 * btnTimKiem.setFont(font2); btnTimKiem.setBackground(color1);
		 * btnTimKiem.setForeground(Color.WHITE);
		 */
		btnLamMoi = new JButton("Làm mới");
		btnLamMoi.setIcon(new ImageIcon(FrmTimKiemKhachHang.class.getResource("/img/Button-Refresh-icon2.png")));
		btnLamMoi.setBackground(color1);
		btnLamMoi.setForeground(Color.WHITE);
		btnLamMoi.setFont(font2);
		/*
		 * btnSua = new JButton("Sửa"); btnSua.setIcon(new
		 * ImageIcon(FrmTimKiemKhachHang.class.getResource("/img/DanhMuc_Sua.png")));
		...
		btnXoa.setIcon(new ImageIcon(FrmTimKiemKhachHang.class.getResource("/img/DanhMuc_Xoa.png")));
		btnXoa.setBackground(color1);
		btnXoa.setForeground(Color.WHITE);
		btnXoa.setFont(font2);
		btnLuu = new JButton("Lưu");
		btnLuu.setIcon(new ImageIcon(FrmTimKiemKhachHang.class.getResource("/img/DanhMuc_Luu.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(btnTimKiem)) {
			...
			ArrayList<KhachHang> dsTimDuoc = daoKH.getTimKiemDSKH(maKH, loaiKH, tenKH, sdt, diem, ghichu);
			if (dsTimDuoc.size() > 0) {
				loadData(dsTimDuoc);
			} else {
		...
		if (obj.equals(cbLoaiKH)) {
			if (cbLoaiKH.getSelectedItem() != null) {
				dsTimDuoc = daoKH.getTimKiemDSKH(txtMaKH.getText(), cbLoaiKH.getSelectedItem().toString(),
						txtTenKH.getText(), txtSDT.getText(), txtDiem.getText(), taGhiChu.getText());
				loadData(dsTimDuoc);
			}
		}
	}
	...
	public void keyReleased(KeyEvent e) {
		...
		dsTimDuoc = daoKH.getTimKiemDSKH(txtMaKH.getText(), cbLoaiKH.getSelectedItem().toString(), txtTenKH.getText(),
				txtSDT.getText(), txtDiem.getText(), taGhiChu.getText());
		loadData(dsTimDuoc);
	}
