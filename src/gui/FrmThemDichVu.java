...
public class FrmThemDichVu extends JFrame implements ActionListener {
	...
	public FrmThemDichVu(String maPhong, String maNhanVienNhan) {
		...
		this.addWindowListener((WindowListener) new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				FrmXuLyPhongDangSuDung.dsALL_CTHD_DV = dao_CTHD_DV.getAllDanhSach();
		...
		lbl_TieuDe.setIcon(new ImageIcon(
				FrmThemDichVu.class.getResource("/img/vecteezy_abstract-purple-fluid-wave-background_.jpg")));
		...
		btn_TimKiem.setIcon(new ImageIcon(getClass().getResource("/img/Search-icon.png")));
		...
		btn_LamMoi.setIcon(new ImageIcon(getClass().getResource("/img/Button-Refresh-icon.png")));
		...
		btn_QuayLai.setIcon(new ImageIcon(FrmThemDichVu.class.getResource("/img/return.png")));
		...
		btn_Them.setIcon(new ImageIcon(FrmThemDichVu.class.getResource("/img/DanhMuc_Them.png")));
		...
		btn_HieuChinh.setIcon(new ImageIcon(FrmThemDichVu.class.getResource("/img/DanhMuc_Sua.png")));
		...
		btn_Xoa.setIcon(new ImageIcon(FrmThemDichVu.class.getResource("/img/Close-2-icon.png")));
		...
		docBangDichVu(dao_DichVu.getAllDichVu(), "Tất cả");
		laySoLuongTungLoai();
		setNutThemXoa(false);
		// sự kiện
	...
	public void layThongTinPhong(String maPhongNhap) {
		phongNhan = dao_Phong.getPhongTheoMa(maPhongNhap);
	}

	public void docThongTinVaoKhachHang() {
	...
	public ChiTietHoaDon_Phong layCTHD_PhongCuoi() {
		ArrayList<ChiTietHoaDon_Phong> dsHoaDon = dao_CTHD_Phong.getDSTheoMaPhong(phongNhan.getMaPhong());
		if (dsHoaDon.size() != 0) {// kiểm tra phòng có hoá đơn nào hay chưa
	...
	public void laySoLuongTungLoai() {
	...
	public void themVaoHoaDon(String maDichVu, int soLuongThem) {
		String maHD = layHDHienTai().getMaHoaDon();
	...
	public int capNhapSoLuong(String maDichVu, int soLuongMoi, String soLuongHienTai) {
		String maHD = layHDHienTai().getMaHoaDon();
		DichVu dVu = dao_DichVu.getDichVuTheoMa(maDichVu);
		ChiTietHoaDon_DichVu cthd_dVu = dao_CTHD_DV.getCTHD_DV(maDichVu, maHD, maPhongTruyen);
	...
	// xoá dịch vụ đã thêm
	public boolean xoaDichVuKH(String maDichVu, String soLuongHienTai) {
		String maHD = layHDHienTai().getMaHoaDon();
		DichVu dVu = dao_DichVu.getDichVuTheoMa(maDichVu);
		ChiTietHoaDon_DichVu cthd_dVu = dao_CTHD_DV.getCTHD_DV(maDichVu, maHD, maPhongTruyen);
		int soLuongHT = Integer.parseInt(soLuongHienTai);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(rdbtn_TatCa)) {
			...
			rdbtn_TatCa.setSelected(true);
			loai = "Tất cả";
			docBangDichVu(dao_DichVu.getAllDichVu(), loai);
		}
		if (obj.equals(rdbtn_DoUong)) {
			setNut(false);
			rdbtn_DoUong.setSelected(true);
			loai = "Đồ uống";
			docBangDichVu(dao_DichVu.getDSDichVuTheoLoai(dao_LoaiDichVu.getLoaiTheoTen("Đồ uống")), loai);
		}
		if (obj.equals(rdbtn_ThucAn)) {
			setNut(false);
			rdbtn_ThucAn.setSelected(true);
			loai = "Thức ăn";
			docBangDichVu(dao_DichVu.getDSDichVuTheoLoai(dao_LoaiDichVu.getLoaiTheoTen("Thức ăn")), loai);
		}
		if (obj.equals(btn_TimKiem)) {
			String tenTimString = txt_Tim.getText();
			docBangDichVu(dao_DichVu.getDSDichVuTheoTenTuongDoi(tenTimString), loai);
		}
