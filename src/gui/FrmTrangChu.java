...
public class FrmTrangChu extends JFrame implements ActionListener {
	...
	public FrmTrangChu(String maNV) {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(FrmTrangChu.class.getResource("/img/karaoke-logo-template-design-vector_316488-16272.jpg")));
		...
		mn_HeThong.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/system-settings-icon.png")));
		...
		mn_DanhMuc.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/Checklist-icon.png")));
		...
		mn_XuLy.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/teamwork.jpg")));
		...
		mn_TimKiem.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/Search-icon.png")));
		...
		mn_ThongKe.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/statistics-market-icon.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/icons8-address-30.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/icons8-phone-30.png")));
		...
		lblNewLabel_3.setIcon(new ImageIcon(
				FrmTrangChu.class.getResource("/img/karaoke-logo-template-design-vector_316488-16272.jpg")));
		lblNewLabel_3.setBounds(628, 445, 100, 100);
		panel_TrangChu.add(lblNewLabel_3);

		JLabel lblNewLabel_5 = new JLabel("");
		lblNewLabel_5.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/Karaoke-LUXURY-Làn-Sóng-Xanh-10.jpg")));
		...
		// phím tắt - CHƯA XONG
		mntm_TrangChu.setMnemonic(KeyEvent.VK_H);
...
//		mntm_ThongKeKH.setMnemonic(KeyEvent.VK_F9);
	...
	public void kiemTraSinhNhat() {
		...
		if (nVien.getNgaySinh().getDayOfYear() == ngayHT.getDayOfYear()
			...
			txt_ThongTin.setIcon(new ImageIcon(FrmTrangChu.class.getResource("/img/icons8-gift-32.png")));
	...
	public void kiemTraChucVu(String maNhanVien) {
		...
		if (nhanVien.getLoaiNhanVien().getMaLoai().equals("LNV001")) {
			chucNangQL = true;
			return;
		}
		if (nhanVien.getLoaiNhanVien().getMaLoai().equals("LNV002")) {
			chucNangTN = true;
			return;
		}
		if (nhanVien.getLoaiNhanVien().getMaLoai().equals("LNV003")) {
			chucNangKT = true;
			return;
		}
	}

	public void hienThiTT(String maNhanVien) {
		// kiểm tra admin
		if (maNhanVien.equals("admin")) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(mntm_TrangChu)) {
			...
			FrmXemThongTinTK frmXemThongTinTK = new FrmXemThongTinTK(maNhanVienTruyen);
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			...
			try {
				...
				else if (nhanVien.getLoaiNhanVien().getMaLoai().equals("LNV001"))
					url = System.getProperty("user.dir") + "\\help\\HuongDanQuanLy.pdf";
				else if (nhanVien.getLoaiNhanVien().getMaLoai().equals("LNV002"))
					url = System.getProperty("user.dir") + "\\help\\HuongDanThuNgan.pdf";
				else if (nhanVien.getLoaiNhanVien().getMaLoai().equals("LNV003"))
		...
		// Danh mục
			...
			FrmQuanLyKhachHang frmQuanLyKhachHang = new FrmQuanLyKhachHang(maNhanVienTruyen, "", "");
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmQuanLyKhachHang.pnBorder);
		} else if (obj.equals(mntm_NhanVien)) {
			FrmQuanLyNhanVien frmQuanLyNhanVien = new FrmQuanLyNhanVien(dao_NhanVien.getALLNhanVienKhongCoADMIN());
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmQuanLyNhanVien.pnBorder);
		} else if (obj.equals(mntm_DichVu)) {
			FrmQuanLyDichVu frmQuanLyDichVu = new FrmQuanLyDichVu(dao_DichVu.getAllDichVu());
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmQuanLyDichVu.pnlBorder);
		} else if (obj.equals(mntm_LoaiDichVu)) {
			FrmQuanLyLoaiDichVu frmQuanLyLoaiDichVu = new FrmQuanLyLoaiDichVu();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmQuanLyLoaiDichVu.pnlBorder);
		} else if (obj.equals(mntm_DonVi)) {
			FrmQuanLyDonVi frmQuanLyDonVi = new FrmQuanLyDonVi();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmQuanLyDonVi.pnlBorder);
		} else if (obj.equals(mntm_PhongHat)) {
			FrmQuanLyPhong frmQuanLyPhong = new FrmQuanLyPhong(dao_Phong.getDanhSachPhong());
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmQuanLyPhong.pnlBorder);
		} else if (obj.equals(mntm_LoaiPhongHat)) {
			FrmQuanLyLoaiPhong frmQuanLyLoaiPhong = new FrmQuanLyLoaiPhong();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			...
			FrmQuanLyLoaiKhacHang frmQuanLyLoaiKH = new FrmQuanLyLoaiKhacHang();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmQuanLyLoaiKH.pnBorder);
		} else if (obj.equals(mntm_LoaiNhanVien)) {
			FrmQuanLyLoaiNhanVien frmQuanLyLoaiNV = new FrmQuanLyLoaiNhanVien();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmQuanLyLoaiNV.pnBorder);
		}
		// Xử lý
		else if (obj.equals(mntm_DatPhongHat)) {
			FrmXyLyDatPhong frmDatPhong = new FrmXyLyDatPhong(maNhanVienTruyen);
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmDatPhong.pnBorder);
		} else if (obj.equals(mntm_PhongCho)) {
			FrmXyLyPhieuDatPhong frmDatPhongDSD = new FrmXyLyPhieuDatPhong(maNhanVienTruyen, "");
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmDatPhongDSD.pnBorder);
		} else if (obj.equals(mntm_PhongDangSD)) {
			FrmXuLyPhongDangSuDung frmDatPhongDSD = new FrmXuLyPhongDangSuDung(maNhanVienTruyen, "");
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmDatPhongDSD.pnBorder);
		}
		// Tìm kiếm
		else if (obj.equals(mntm_TimKiemPhong)) {
			FrmTimKiemPhong frmTimKiemPhong = new FrmTimKiemPhong(maNhanVienTruyen);
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmTimKiemPhong.pnlBorder);
		} else if (obj.equals(mntm_TimPhieuDat)) {
			FrmTimKiemPhieuDatPhong frmTimKiemPhieuDatPhong = new FrmTimKiemPhieuDatPhong();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmTimKiemPhieuDatPhong.pnBorder);
		} else if (obj.equals(mntm_TimKiemDichVu)) {
			FrmTimKiemDichVu frmTimKiemDichVu = new FrmTimKiemDichVu(maNhanVienTruyen);
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmTimKiemDichVu.pnlBorder);
		} else if (obj.equals(mntm_TimKiemNhanVien)) {
			FrmTimKiemNhanVien frmTimKiemNhanVien = new FrmTimKiemNhanVien(maNhanVienTruyen);
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			...
			FrmTimKiemTaiKhoan frmTimKiemTaiKhoan = new FrmTimKiemTaiKhoan();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
		...
		// Thống kê
			...
			FrmThongKeKhachHang frmThongKeKH = new FrmThongKeKhachHang();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
			jtab_NoiDung.add(frmThongKeKH.pnlBorder);
		} else if (obj.equals(mntm_ThongKeNV)) {
			FrmThongKeNhanVien frmTKNhanVien = new FrmThongKeNhanVien();
			jtab_NoiDung.remove(jtab_NoiDung.getSelectedComponent());
