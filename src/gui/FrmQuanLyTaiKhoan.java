...
public class FrmQuanLyTaiKhoan extends JFrame implements ActionListener, MouseListener {
	...
	private void createUI() {
		...
		btnThem.setIcon(new ImageIcon(FrmQuanLyTaiKhoan.class.getResource("/img/DanhMuc_Them.png")));
		btnThem.setFont(font2);
		btnThem.setBackground(color1);
		btnThem.setForeground(Color.WHITE);
		btnResetMK = new JButton("Reset mật khẩu");
		btnResetMK.setIcon(new ImageIcon(FrmQuanLyTaiKhoan.class.getResource("/img/Button-Refresh-icon2.png")));
		btnResetMK.setFont(font2);
		btnResetMK.setBackground(color1);
		btnResetMK.setForeground(Color.WHITE);
		btnXoaTrang = new JButton("Xóa trắng");
		btnXoaTrang.setIcon(new ImageIcon(FrmQuanLyTaiKhoan.class.getResource("/img/Button-Refresh-icon2.png")));
		...
		btnXoa.setIcon(new ImageIcon(FrmQuanLyTaiKhoan.class.getResource("/img/DanhMuc_Xoa.png")));
		btnXoa.setBackground(color1);
		btnXoa.setForeground(Color.WHITE);
		btnXoa.setFont(font2);
		btnLuu = new JButton("Lưu");
		btnLuu.setIcon(new ImageIcon(FrmQuanLyTaiKhoan.class.getResource("/img/DanhMuc_Luu.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(btnResetMK)) {
			if (btnResetMK.getText().equals("Reset mật khẩu")) {
				...
				NhanVien maNV = daoNhanVien.getNhanVienTheoMa(maChuTK);
