...
public class FrmQuanLyLoaiKhacHang extends JFrame implements ActionListener, MouseListener {
	...
	private void createUI() {
		...
		btnThem.setIcon(new ImageIcon(FrmQuanLyLoaiKhacHang.class.getResource("/img/DanhMuc_Them.png")));
		btnThem.setFont(font2);
		btnThem.setBackground(color1);
		btnThem.setForeground(Color.WHITE);
		btnSua = new JButton("Sửa");
		btnSua.setIcon(new ImageIcon(FrmQuanLyLoaiKhacHang.class.getResource("/img/DanhMuc_Sua.png")));
		btnSua.setFont(font2);
		btnSua.setBackground(color1);
		btnSua.setForeground(Color.WHITE);
		btnXoaTrang = new JButton("Xóa trắng");
		btnXoaTrang.setIcon(new ImageIcon(FrmQuanLyLoaiKhacHang.class.getResource("/img/Button-Refresh-icon2.png")));
		...
		*/
		...
		btnXoa.setIcon(new ImageIcon(FrmQuanLyLoaiKhacHang.class.getResource("/img/DanhMuc_Xoa.png")));
		btnXoa.setBackground(color1);
		btnXoa.setForeground(Color.WHITE);
		btnXoa.setFont(font2);
		btnLuu = new JButton("Lưu");
		btnLuu.setIcon(new ImageIcon(FrmQuanLyLoaiKhacHang.class.getResource("/img/DanhMuc_Luu.png")));
