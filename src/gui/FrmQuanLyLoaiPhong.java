...
public class FrmQuanLyLoaiPhong extends JFrame implements ActionListener, MouseListener {
	...
	private void createUI() {
		...
		btnThem.setIcon(new ImageIcon(FrmQuanLyLoaiPhong.class.getResource("/img/DanhMuc_Them.png")));
		btnSua = new JButton("Sửa");
		btnSua.setFont(font3);
		btnSua.setBackground(color1);
		btnSua.setForeground(Color.WHITE);
		btnSua.setIcon(new ImageIcon(FrmQuanLyLoaiPhong.class.getResource("/img/DanhMuc_Sua.png")));
		btnXoa = new JButton("Xóa");
		btnXoa.setBackground(color1);
		btnXoa.setForeground(Color.WHITE);
		btnXoa.setFont(font3);
		btnXoa.setIcon(new ImageIcon(FrmQuanLyLoaiPhong.class.getResource("/img/DanhMuc_Xoa.png")));
		btnLuu = new JButton("Lưu");
		btnLuu.setBackground(Color.WHITE);
		btnLuu.setForeground(Color.WHITE);
		btnLuu.setFont(font3);
		btnLuu.setIcon(new ImageIcon(FrmQuanLyLoaiPhong.class.getResource("/img/DanhMuc_Luu.png")));
		...
		if (o.equals(btnThem)) {
			if (btnThem.getText().equals("Thêm")) {
				...
				if (soHang < 999) {
					...
					btnThem.setText("Hủy");
					btnThem.setIcon(new ImageIcon(FrmQuanLyLoaiPhong.class.getResource("/img/DanhMuc_Huy.png")));
		...
		if (o.equals(btnSua)) {
			if (btnSua.getText().equals("Sửa")) {
				...
				if (hangDuocChon > -1) {
					...
					btnSua.setText("Hủy");
					btnSua.setIcon(new ImageIcon(FrmQuanLyLoaiPhong.class.getResource("/img/DanhMuc_Huy.png")));
