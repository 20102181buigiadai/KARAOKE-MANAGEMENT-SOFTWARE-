...
public class FrmTimKiemTaiKhoan extends JFrame implements ActionListener,KeyListener{
	...
	private void createUI() {
		...
		btnLamMoi.setIcon(new ImageIcon(FrmTimKiemTaiKhoan.class.getResource("/img/Button-Refresh-icon2.png")));
		btnLamMoi.setBackground(color1);
		btnLamMoi.setForeground(Color.WHITE);
		btnLamMoi.setFont(font2);
		btnXoaTrang = new JButton("Xóa trắng");
		btnXoaTrang.setIcon(new ImageIcon(FrmTimKiemTaiKhoan.class.getResource("/img/Button-Refresh-icon2.png")));
		...
		*/
		...
		btnXoa.setIcon(new ImageIcon(FrmTimKiemTaiKhoan.class.getResource("/img/DanhMuc_Xoa.png")));
		btnXoa.setBackground(color1);
		btnXoa.setForeground(Color.WHITE);
		btnXoa.setFont(font2);
		btnLuu = new JButton("Lưu");
		btnLuu.setIcon(new ImageIcon(FrmTimKiemTaiKhoan.class.getResource("/img/DanhMuc_Luu.png")));
