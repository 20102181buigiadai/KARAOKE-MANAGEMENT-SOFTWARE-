...
public class FrmXyLyPhieuDatPhong extends JFrame implements Runnable, ActionListener, MouseListener {
	 ...
	 * Create the frame.
	 */
	public FrmXyLyPhieuDatPhong(String nhanVien, String soDTTruyen) {
		setTitle("Đặt phòng");
		...
		time_VaoPhong.getCalendarButton()
				.setIcon(new ImageIcon(FrmXyLyPhieuDatPhong.class.getResource("/img/icons8-calendar-50.png")));
		...
		btn_LocDSTheoTG.setIcon(new ImageIcon(FrmXyLyPhieuDatPhong.class.getResource("/img/Search-icon.png")));
...
//						thongBaoLoi("Giờ ra phải sau giờ vào", "Nhập thời gian vào");
		...
		btn_LocDSTheoKH.setIcon(new ImageIcon(FrmXyLyPhieuDatPhong.class.getResource("/img/Search-icon.png")));
		...
		lbl_ThoiGianDat_8_1.setIcon(new ImageIcon(FrmXyLyPhieuDatPhong.class.getResource("/img/vip-Mini.gif")));
		...
		btn_HuyPhieu.setIcon(new ImageIcon(FrmXyLyPhieuDatPhong.class.getResource("/img/Close-2-icon.png")));
	...
	public void docSDTKhachCoPhieu() {
	...
	public void docThongTinPhong(Phong phong) {
	...
	public void docDSPhieuDat(Phong phong) {
...
//		LocalDateTime thoiGianHTKT = thoiGianHT.plusMinutes(10);// cho đặt sớm 10 phút
	...
	public void setIcon(int viTri, Phong phong) {
		...
		if (phong.getLoaiPhong().getTenLoaiPhong().equals("Vip")) {
			iconVip = new JLabel();
			iconVip.setIcon(new ImageIcon(FrmXyLyPhieuDatPhong.class.getResource("/img/VIP.gif")));
	...
	public boolean kiemTraDSPhong(Phong phong) {
...
//		dao_CTHD_DichVu.themCTHD_DVMoi(cthd_DV);
	...
	public ArrayList<Phong> getDSPhongTheoTG() {
	...
	public ArrayList<Phong> getDSPhongTheoKH() {
		dsAllPhieuDat = dao_PhieuDatPhong.getDSTheoTrangThai("Đang chờ");
		ArrayList<Phong> dsPhong = dsDLHienTai;
		dsPhong.removeAll(dsPhong);
	...
	public void mouseClicked(MouseEvent e) {
		...
		int hangDuocChon = tb_dsPhieuDatPhong.getSelectedRow();
		ArrayList<PhieuDatPhong> dsPhieu = dao_PhieuDatPhong.getTheoMaPhong_TrangThai(maPhongDuocChon, "Đang chờ");
