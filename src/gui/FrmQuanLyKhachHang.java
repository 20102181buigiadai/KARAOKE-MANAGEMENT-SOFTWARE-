...
public class FrmQuanLyKhachHang extends JFrame implements ActionListener, MouseListener {
	...
	public FrmQuanLyKhachHang(String maNhanVien, String sdtMoi, String trangTroVe) {
	...
	private void createUI(String maNhanVien, String sdtMoi, String trangTroVe) {
		...
		btnThem.setIcon(new ImageIcon(FrmQuanLyKhachHang.class.getResource("/img/DanhMuc_Them.png")));
		btnThem.setFont(font2);
		btnThem.setBackground(color1);
		btnThem.setForeground(Color.WHITE);
		btnSua = new JButton("Sửa");
		btnSua.setIcon(new ImageIcon(FrmQuanLyKhachHang.class.getResource("/img/DanhMuc_Sua.png")));
		btnSua.setFont(font2);
		btnSua.setBackground(color1);
		btnSua.setForeground(Color.WHITE);
		btnXoaTrang = new JButton("Xóa trắng");
		btnXoaTrang.setIcon(new ImageIcon(FrmQuanLyKhachHang.class.getResource("/img/Button-Refresh-icon2.png")));
		...
		btnXoa.setIcon(new ImageIcon(FrmQuanLyKhachHang.class.getResource("/img/DanhMuc_Xoa.png")));
		btnXoa.setBackground(color1);
		btnXoa.setForeground(Color.WHITE);
		btnXoa.setFont(font2);
		btnLuu = new JButton("Lưu");
		btnLuu.setIcon(new ImageIcon(FrmQuanLyKhachHang.class.getResource("/img/DanhMuc_Luu.png")));
...
//			}
			...
			btn_ChuyenPhong.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (trangTroVe.equals("FrmDatPhongDangSuDung")) {
						FrmXuLyPhongDangSuDung frmTroVe = new FrmXuLyPhongDangSuDung(maNhanVienTruyen, sdtMoi);
						...
						FrmXyLyDatPhong frmTroVe = new FrmXyLyDatPhong(maNhanVienTruyen);
						FrmTrangChu.jtab_NoiDung.remove(FrmTrangChu.jtab_NoiDung.getSelectedComponent());
						FrmTrangChu.jtab_NoiDung.add(frmTroVe.pnBorder);
					}
